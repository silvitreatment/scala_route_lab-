...
- **MySQL 8** — хранение статических данных
...
mysql -h 127.0.0.1 -u root -proot routelab < infra/seed.sql
```
...
├── infra/                  # MySQL DDL (init.sql) и демо-данные (seed.sql)
├── api-gateway/            # Pekko HTTP, auth middleware, rate limit
├── tenant-service/         # Аутентификация API ключей, MySQL
├── transit-catalog-service/# Остановки, маршруты, расписание, MySQL
