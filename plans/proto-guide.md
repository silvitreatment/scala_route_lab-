...
Хранит расписание, остановки и маршруты в PostgreSQL. Другие сервисы (routing, eta) не имеют прямого доступа к БД — они запрашивают данные через этот gRPC контракт.
